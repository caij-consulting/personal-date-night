...
import { faCheckDouble, faCheck, faUser, faTimes, faCopy, faSortDown } from '@fortawesome/free-solid-svg-icons'

library.add(fab, faCheckDouble, faCheck, faUser, faTimes, faCopy)

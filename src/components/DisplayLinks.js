  ...
  render() {
    return(
      ...
      <button ref={this.modalRef}
        ...
        <FontAwesomeIcon icon="user" aria-hidden="true" /><p>User One: <a href={this.props.user1choice.url} target="_blank" rel="noopener noreferrer" aria-label="Click to get your tickets here!">{this.props.user1choice.name}</a> </p>
      
        <FontAwesomeIcon icon="user" aria-hidden="true" /><p>User Two: <a href={this.props.user2choice.url} target="_blank" rel="noopener noreferrer" aria-label="Click to get your tickets here!">{this.props.user2choice.name}</a></p>
        <a href="#" className="keepFocusModal" onTransitionEnd={this.loopFocus} aria-hidden="true"></a>
      </div>
    );
  }
